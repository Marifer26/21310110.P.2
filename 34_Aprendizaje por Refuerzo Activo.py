...
# Crear una instancia del agente de aprendizaje por refuerzo activo
agente = AprendizajePorRefuerzoActivo(num_estados, num_acciones, matriz_recompensas, factor_descuento, tasa_aprendizaje, epsilon)
